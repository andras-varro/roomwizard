...
- **OPL tempo** — verify on device with KQ3 intro vs reference recording after mono mixer fix. **Blocked: no game data is installed on the device**, so there is no KQ3 to play (`../IMPROVEMENT_PLAN.md` B12c).
