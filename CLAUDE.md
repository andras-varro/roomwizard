...
| `common/audio.c`, `common/audio_gen.c`, `common/audio.h` | `native_apps` only — **measured**: neither `vnc_client` (`Makefile` `SRCS`) nor ScummVM links `audio.o`; ScummVM has its own OSS mixer |
