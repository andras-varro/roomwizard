...
usage() {
    ...
    echo "                   boot with an empty socket. ⚠️ UNVERIFIED ON HARDWARE —"
    echo "                   IMPROVEMENT_PLAN.md B32 item 10 is the measurement that"
    echo "                   decides it. Needs a reboot; the undo is uImage-system.vendor."
