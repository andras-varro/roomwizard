...
int main(int argc, char *argv[]) {
    ...
    /* The music bed: a playlist over music/frogger<n>-mono.wav, with the four
     * states and the hold/resume rules in common/audio_bed.c (F1 Phase 5 ⑤).
     * Its config keys are frogger_music, frogger_music2 …, and ⚠️ the FIRST of
     * those set empty is this game's music off switch. */
    AudioBed bed;
    audio_bed_init(&bed, &audio, "frogger", "frogger", 4);
